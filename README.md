...
| [`Embedded-Linux`](https://github.com/4trastos/Embedded-Linux-Scripting-Bootcamp) | Proyecto personal de aprendizaje progresivo para dominar el scripting en Linux orientado a sistemas embebidos.| ![Última actualización](https://img.shields.io/github/last-commit/4trastos/PDF_Converter?style=flat-square) |
