...
|------------------|-------------|----------------------|
| [`strace`](https://github.com/4trastos/strace) | `strace` es una herramienta de depuración para Linux que utiliza la función del kernel `ptrace` para monitorear las llamadas al sistema y las señales de un programa. | ![Última actualización](https://img.shields.io/github/last-commit/4trastos/lem-ipc?style=flat-square) |
