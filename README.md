...
| Proyecto         | Descripción | Última actualización |
|------------------|-------------|----------------------|
| [`pdf2data`](https://github.com/4trastos/PDF_Converter) | Aplicación empresarial en Python para el control de gastos mediante la extracción de datos de facturas PDF, almacenamiento en BBDD y generación de estadísticas,visualizaciones y proyección de gastos futuros.| ![Última actualización](https://img.shields.io/github/last-commit/4trastos/PDF_Converter?style=flat-square) |
